...
import com.kipchulovidovi.lovidovi.models.ChangedForgotPassModel;
import com.kipchulovidovi.lovidovi.ui.MainActivity;
import com.kipchulovidovi.lovidovi.R;
import com.kipchulovidovi.lovidovi.models.SendCodeModel;
import com.kipchulovidovi.lovidovi.models.UsersModel;
import com.kipchulovidovi.lovidovi.networking.RetrofitClient;
import com.kipchulovidovi.lovidovi.receivers.AppSignatureHashHelper;
import com.kipchulovidovi.lovidovi.receivers.ZikySMSReceiver;
        ...
        call.enqueue(new Callback<SendCodeModel>() {
            ...
            public void onResponse(Call<SendCodeModel> call, Response<SendCodeModel> response) {
                ...
                if(response.code()==201){
                    startSMSListener();
                    startCountDownTimer();
                    Toast.makeText(CodeVerificationActivity.this,"Your verification code has been sent",Toast.LENGTH_SHORT).show();
                }
                else{
